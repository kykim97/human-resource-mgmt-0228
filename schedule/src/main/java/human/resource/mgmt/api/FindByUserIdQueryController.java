...
@RestController
public class FindByUserIdQueryController {

    private final QueryGateway queryGateway;

    private final ReactorQueryGateway reactorQueryGateway;

    public FindByUserIdQueryController(
    ...
    public CompletableFuture findAll(FindByUserIdQuery query) {
        return queryGateway
            .query(
                query,
    ...
    public CompletableFuture findById(@PathVariable("id") String id) {
        FindByUserIdSingleQuery query = new FindByUserIdSingleQuery();
        query.setUserId(id);
